...
```bash
brew install ffmpeg rubberband   # mp3/opus encoding + formant-preserving time-stretch
python3 -m venv venv
./venv/bin/pip install mlx-audio uvicorn fastapi webrtcvad-wheels pyrubberband soundfile scipy
